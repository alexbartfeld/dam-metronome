...
import metroPlayer from "../../utils/metronome-player";
import {Sound} from "../../utils/sound-bank";
    ...
    return (
      <Host>
        ...
        <div class="flex-row--end margin-top">
          ...
          <div id="sub-division">
            <button class={this.subDiv === Subdivision.quarter ? "sub-division__btn active" : "sub-division__btn"}
                    onClick={() => {
                      this.handleSubDivisionChange(Subdivision.quarter)
                    }}>1/4
            </button>
            <button class={this.subDiv === Subdivision.eight ? "sub-division__btn active" : "sub-division__btn"}
                    onClick={() => {
                      this.handleSubDivisionChange(Subdivision.eight)
                    }}>1/8
            </button>
            <button class={this.subDiv === Subdivision.sixteen ? "sub-division__btn active" : "sub-division__btn"}
                    onClick={() => {
